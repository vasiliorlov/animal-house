...
public class KCFloatingActionButton: UIView {
	...
	*/
    ...
    /**
        Button color.
    */
    @IBInspectable public var buttonColor: UIColor =  UIColor(red: 240/255.0, green: 0/255.0, blue: 0/255.0, alpha: 0.80)//UIColor(red: 73/255.0, green: 151/255.0, blue: 241/255.0, alpha: 1)
